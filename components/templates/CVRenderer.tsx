    ...
    return ( // Added key for DynamicMainSections map
      <>
        {order.map((key) => {
          ...
          if (key === "skills" && ["Horizon", "Eclipse", "Hyperion", "Lunar", "Stellar", "Solar", "Nebula", "Europass", "Galaxy", "Prism", "Navy", "Vertex", "Verde", "Rose", "Azure", "Pamela", "Liverpool", "Lumiere", "Hartmann", "Patterson", "Bremen", "Sevilla", "Munich", "Marina"].includes(templateStyle)) return null;
          ...
          if (key === "languages" && ["Eclipse", "Hyperion", "Lunar", "Stellar", "Solar", "Nebula", "Europass", "Prism", "Navy", "Vertex", "Verde", "Rose", "Azure", "Pamela", "Liverpool", "Lumiere", "Hartmann", "Patterson", "Bremen", "Sevilla", "Munich", "Marina"].includes(templateStyle)) return null;
          ...
          <div className="bg-teal-700 px-14 py-10 flex items-center gap-6">
            ...
            <div className="min-w-0">
              ...
              <div className="flex flex-wrap gap-x-6 gap-y-1 mt-3">
                <span className="flex items-center gap-1.5 text-[10px] text-teal-50"><Phone size={11} /><InlineEdit value={contact?.phone || ""} path="contact.phone" isInteractive={isInteractive} onUpdate={onUpdate} /></span>
                <span className="flex items-center gap-1.5 text-[10px] text-teal-50"><Mail size={11} /><InlineEdit value={contact?.email || ""} path="contact.email" isInteractive={isInteractive} onUpdate={onUpdate} /></span>
                <span className="flex items-center gap-1.5 text-[10px] text-teal-50"><MapPin size={11} /><InlineEdit value={contact?.location || ""} path="contact.location" isInteractive={isInteractive} onUpdate={onUpdate} /></span>
              </div>
            </div>
          </div>
