// /**
//  * Additive migration script — run once to apply the three new tables.
//  * Safe: uses IF NOT EXISTS / CREATE TYPE ... IF NOT EXISTS idiom.
//  * Execute with:  node scripts/migrate-new-tables.mjs
//  */
...
// const statements = [
//   // 1. Enum (idempotent: DO block skips if already exists)
//   `DO $$ BEGIN
